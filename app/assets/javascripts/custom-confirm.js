...
(function () {
    ...
    function getTemplate() {
        if (! template) {
            ...
            template.innerHTML = '<div class="c2_content"> <header1 class="c2_header"> <h2 class="c2_title"></h2> <button class="c2_btn-close"></button> </header1> <div class="c2_body"> </div><div class="c2_footer"> <button class="c2_btn-no"></button> <button class="c2_btn-yes"></button> </div>';
        }
