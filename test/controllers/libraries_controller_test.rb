...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { description: @library.description, name: @library.name, type: @library.type } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { description: @library.description, name: @library.name, type: @library.type } }
